...
รวมถึงการพัฒนาและบำรุงรักษา Terraform Modules สำหรับโมดูลกลางที่ถูกใช้งานทั้งใน SCB TechX และ SCB อีกทั้งยังมีส่วนในค้นหาวิธีการแก้ไขปัญหาต่าง ๆ ที่เกิดขึ้นระหว่างการทำงาน ซึ่งทั้งหมดนี้เป็นส่วนสำคัญในการเพิ่มประสิทธิภาพและความคล่องตัวให้กับกระบวนการ DevOps ของ
...
During the work period, I participated in supporting the software development team, particularly in the creation and deletion of resources, as well as the development and maintenance of Terraform Modules for central modules used in both SCB TechX and SCB, and also contributed to finding ways to solve various problems that occurred during work.
...
\begin{acknowledgments}
    ...
    \begin{enumerate}
        \item สุมนา ว่องรัตนะกุล — DevOps Manager
        \item พีรวัตร อยู่ใจเย็น — Sernior DevOps Engineer
        \item ภัทรพล หมวกมณี — DevOps Engineer
    \end{enumerate}
